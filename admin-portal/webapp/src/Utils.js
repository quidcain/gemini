...
export function format(date, format) {
    return date ? moment(date).format(format) : "Ninguna";
}

export function formatWithMsg(date, format, message) {
    return date ? moment(date).format(format) : message;
}
...
export function normalizeEnumValue(value) {
    return ((value && (value === "-1" || value === -1)) || !value) ? null : value;
}
...
export function isEmptyValue(value) {
    return !value || value === "-1" || value === null || value === -1;
}
