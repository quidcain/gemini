...
let field = {
    ...
    number: {min: 1, max: 3, regex: onlyNumber},
    ...
    text: {length: 50, regex: allCharacters}
};
...
class TextInput extends Component {
    ...
    render() {
        ...
        let customCss = !props.iconname ? {paddingLeft: 10, ...props.style} : props.style;
        ...
        return (
            ...
            <div className={this.props.plain ? "" : groupClass}>
                <input {...props}
                       autoCorrect="none"
                       autoCapitalize="none"
                       autoFocus={true}
