...
export default class AnimationHelper extends Component {
    ...
    componentWillMount() {
        let base = `/${env.default.baseContext}-statics`;
        // if ("registro-pruebas" === env.default.baseContext || "srs" === env.default.baseContext) {
            base = "https://prdesieprod.dde.pr/registro-statics";
        // }
